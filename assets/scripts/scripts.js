...
typewriter.typeString('hey there!')
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("my name is andrea.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm a grad student at csu east bay.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i graduated with a bs in computer science.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i'm currently in my masters studying data science.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i love teaching.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("i also like photogrpahy")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
